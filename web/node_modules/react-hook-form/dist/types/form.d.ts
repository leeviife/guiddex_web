...
export declare type UnpackNestedValue<T> = NonUndefined<T> extends NestedValue<infer U> ? U : NonUndefined<T> extends object ? {
...
export declare type Resolver<TFieldValues extends FieldValues = FieldValues, TContext extends object = object> = (values: TFieldValues, context?: TContext, validateAllFieldCriteria?: boolean) => Promise<ResolverResult<TFieldValues>>;
...
export declare type UseFormMethods<TFieldValues extends FieldValues = FieldValues> = {
    ...
    watch<TFieldName extends string, TFieldValue extends TFieldValues[TFieldName]>(name: TFieldName, defaultValue?: UnpackNestedValue<LiteralToPrimitive<TFieldValue>>): UnpackNestedValue<LiteralToPrimitive<TFieldValue>>;
